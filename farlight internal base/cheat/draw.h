...
void DrawLine(const ImVec2& aPoint1, const ImVec2 aPoint2, const ImU32& aColor)
{
	ImGui::GetOverlayDrawList()->AddLine(aPoint1, aPoint2, ImGui::GetColorU32(aColor));
}
...
static void DrawBox(int x, int y, int w, int h, const ImU32& color, int thickness)
{
